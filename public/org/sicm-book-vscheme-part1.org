...
The examples of this whole chapter are to be solved as puzzles only, they cannot be successfully executed.

The executable code of the examples can, however, be viewed and modified on another html page [3].
